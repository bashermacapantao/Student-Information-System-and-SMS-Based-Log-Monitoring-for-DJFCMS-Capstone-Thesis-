      ...
      <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <h2 class="text-center"> <b>Grade - II | Adviser List</b></h2>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <!-- <button id="reset_gradetwosection" class="btn btn-sm btn-outline-info">Reset section</button>
                    <button id="reset_gradetwoyear" class="btn btn-sm btn-outline-info">Reset year</button> -->
                    <button id="gradetworeset" class="btn btn-sm btn-defalut btn-basher">Reset</button>
                </div>
                <div class="row">
