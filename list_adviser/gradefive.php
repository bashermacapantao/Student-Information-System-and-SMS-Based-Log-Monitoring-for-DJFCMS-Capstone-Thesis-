      ...
      <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <h2 class="text-center"> <b>Grade - V | Adviser List</b></h2>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <!-- <button id="reset_gradefivesection" class="btn btn-sm btn-outline-info">Reset section</button>
                    <button id="reset_gradefiveyear" class="btn btn-sm btn-outline-info">Reset year</button> -->
