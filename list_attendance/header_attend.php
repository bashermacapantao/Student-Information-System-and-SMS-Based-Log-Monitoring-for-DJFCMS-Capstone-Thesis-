...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css"
        ...
        <link rel= "stylesheet" type="text/css" href= "../dependecies/datables/buttons.dataTables.min.css">
    ...
    <!-- <link rel="stylesheet" type="text/css"
        ...
        <!-- <script src="../dependecies/popper.min.js"></script>  
        <script src="../dependecies/bootstrapmodal.min.js"></script>   -->
        <!-- <link rel= "stylesheet" type="text/css" href= "../dependecies/datables/buttons.dataTables.min.css"> -->
